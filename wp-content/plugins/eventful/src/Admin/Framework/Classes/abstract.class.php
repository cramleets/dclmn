 ...
 *
 */
if (! class_exists('EventfulAbstract')) {
  abstract class EventfulAbstract
  {
    ...
    public function __construct()
    {
      ...
      if (! empty($this->args['output_css']) || ! empty($this->args['enqueue_webfont'])) {
        ...
        Eventful::$css = apply_filters("eventful_{$this->unique}_output_css", Eventful::$css, $this);
      }
    }
    ...
    public function recursive_output_css($fields = array(), $combine_field = array())
    {
      ...
      if (! empty($fields)) {
        ...
        foreach ($fields as $field) {
          ...
          $field_class  = 'EventfulField_' . $field_type;
