...
if ( ! class_exists( 'EVENTFUL_Taxonomy_Options' ) ) {
  class EVENTFUL_Taxonomy_Options extends EventfulAbstract{
        ...
        if ( $taxonomy === $this->taxonomy ) {
          ...
          if ( ! empty( $section['fields'] ) ) {
            foreach ( $section['fields'] as $field ) {
              ...
              Eventful::field( $field, $this->get_meta_value( $field, $term_id ), $this->unique, 'taxonomy' );
