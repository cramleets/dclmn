 ...
 *
 */
if (! class_exists('EventfulOptions')) {
  class EventfulOptions extends EventfulAbstract
  {
    ...
    public function add_options_html()
    {
      ...
      echo ($has_nav && $this->args['show_all_options']) ? '<div class="eventful-expand-all" title="' . esc_html__('show all settings', 'eventful') . '"><i class="icofont-outdent"></i></div>' : '';
      ...
      if ($has_nav) {
        ...
        foreach ($this->pre_tabs as $tab) {
          ...
          if (! empty($tab['subs'])) {
            ...
            echo '<a href="#tab=' . esc_attr($tab_id) . '" data-tab-id="' . esc_attr($tab_id) . '" class="eventful-arrow">' . wp_kses_post($tab_icon) . wp_kses_post($tab['title']) . wp_kses_post($tab_error) . '</a>';
            ...
            echo '<li class="eventful-tab-item"><a href="#tab=' . esc_attr($tab_id) . '" data-tab-id="' . esc_attr($tab_id) . '">' . wp_kses_post($tab_icon) . wp_kses_post($tab['title']) . wp_kses_post($tab_error) . '</a></li>';
          }
        }
      ...
      foreach ($this->pre_sections as $section) {
        ...
        echo ($has_nav) ? '<div class="eventful-section-title"><h3>' . wp_kses_post($section_icon . $section_title) . '</h3></div>' : '';
        ...
        if (! empty($section['fields'])) {
          ...
          foreach ($section['fields'] as $field) {
            ...
            Eventful::field($field, $value, $this->unique, 'options');
          }
        } else {
