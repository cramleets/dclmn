 ...
 *
 */
if (! class_exists('EventfulFields')) {
  /**
   *
   * Fields Class
   *
   ...
   * @version 1.0.0
   */
  abstract class EventfulFields extends EventfulAbstract
  {
    ...
    public function field_after()
    {
      ...
      $output .= (! empty($this->field['help'])) ? '<div class="eventful-help"><span class="eventful-help-text">' . $this->field['help'] . '</span><i class="icofont-question-circle"></i></div>' : '';
    ...
    public static function field_data($type = '', $term = false, $query_args = array(), $field_unique = null)
    {
      ...
      switch ($type) {
        ...
        case 'taxonomy':
          global $post;
          $view_options       = get_post_meta($post->ID, 'eventful_view_options', true);
