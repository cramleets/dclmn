...
if ( ! class_exists( 'WP_Customize_Panel_EVENTFUL' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_EVENTFUL extends WP_Customize_Panel {
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_EVENTFUL' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_EVENTFUL extends WP_Customize_Section {
    public $type = 'eventful';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_EVENTFUL' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_EVENTFUL extends WP_Customize_Control {
    ...
    public function render_field_content() {
      ...
      $complex = apply_filters( 'eventful_customize_complex_fields', array(
        'accordion',
        'background',
        'border',
        'button_set',
      ...
      Eventful::field( $this->field, $this->value(), $this->unique, 'customize' );
