...
if ( ! class_exists( 'EventfulField_accordion' ) ) {
  class EventfulField_accordion extends EventfulFields {
    ...
    public function render() {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="eventful-accordion-item">';
          ...
          $icon = ( ! empty( $accordion['icon'] ) ) ? 'eventful--icon '. $accordion['icon'] : 'eventful-accordion-icon icofont-rounded-right';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            Eventful::field( $field, $field_value, $unique_id, 'field/accordion' );
