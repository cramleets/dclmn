 ...
 *
 */
if (! class_exists('EventfulField_select')) {
  class EventfulField_select extends EventfulFields
  {
      ...
      if (isset($this->field['options'])) {
        ...
        if ((is_array($options) && ! empty($options)) || (! empty($args['chosen']) && ! empty($args['ajax']))) {
          ...
          if (! empty($args['chosen']) && ! empty($args['multiple'])) {
            ...
            echo '<select name="' . wp_kses_post($field_name) . '" class="eventful-hide-select hidden"' . wp_kses_post($multiple_attr) . wp_kses_post($field_attr) . '>';
          ...
          echo '</select>';
          if (isset($args['preview']) && 'grid' == $args['preview']) {
            echo '<img src="' . esc_url(EVENTFUL_DIR_URL . 'src/Admin/Framework/assets/theme/grid/' . $selected_value . '.webp') . '" class="theme_preview">';
          } else if (isset($args['preview']) && 'minimal_list' == $args['preview']) {
            echo '<img src="' . esc_url(EVENTFUL_DIR_URL . 'src/Admin/Framework/assets/theme/minimal-list/' . $selected_value . '.webp') . '" class="theme_preview">';
          }
        } else {
