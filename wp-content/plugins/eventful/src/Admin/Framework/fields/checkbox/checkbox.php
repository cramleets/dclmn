 ...
 *
 */
if ( ! class_exists( 'EventfulField_checkbox' ) ) {
  class EventfulField_checkbox extends EventfulFields {
    ...
    public function render() {
      ...
      if ( isset( $this->field['options'] ) ) {
        ...
        echo ( ! empty( $this->field['label'] ) ) ? '<span class="eventful--text">'. wp_kses_post( $this->field['label'] ) .'</span>' : '';
        echo '</label>';
        echo '<span class="hide-taxonomy-name" style="display:none;">'. esc_html__('Hide Taxonomy Name', 'eventful') .'</span>';
      }
