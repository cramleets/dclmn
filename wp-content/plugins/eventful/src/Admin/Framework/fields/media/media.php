 ...
 *
 */
if ( ! class_exists( 'EventfulField_media' ) ) {
  class EventfulField_media extends EventfulFields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<i class="eventful--remove icofont-close"></i><span><img src="'. esc_url( $preview_src ) .'" class="eventful--src" /></span>';
        echo '</div>';
        echo '</div>';
      ...
      echo '<a href="#" class="button button-primary eventful--button" data-library="'. esc_attr( $library ) .'" data-preview-size="'. esc_attr( $args['preview_size'] ) .'">'. wp_kses_post($args['button_title'] ) .'</a>';
      echo ( empty( $args['preview'] ) ) ? '<a href="#" class="button button-secondary eventful-warning-primary eventful--remove'. esc_attr( $hidden_auto ) .'">'. wp_kses_post($args['remove_title']) .'</a>' : '';
      echo '</div>';
