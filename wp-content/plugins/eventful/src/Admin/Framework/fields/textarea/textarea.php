...
if ( ! class_exists( 'EventfulField_textarea' ) ) {
  class EventfulField_textarea extends EventfulFields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( Eventful::$shortcode_instances ) ) ? Eventful::$shortcode_instances : array();
