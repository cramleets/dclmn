 ...
 *
 */
if ( ! class_exists( 'EventfulField_map' ) ) {
  class EventfulField_map extends EventfulFields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'eventful-leaflet' ) ) {
        wp_enqueue_script( 'eventful-leaflet', esc_url( $this->cdn_url . $this->version .'/dist/leaflet.js' ), array( 'eventful' ), $this->version, true );
      }

      if ( ! wp_style_is( 'eventful-leaflet' ) ) {
        wp_enqueue_style( 'eventful-leaflet', esc_url( $this->cdn_url . $this->version .'/dist/leaflet.css' ), array(), $this->version );
      }
