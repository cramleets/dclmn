...
if ( ! class_exists( 'EventfulField_sortable' ) ) {
  class EventfulField_sortable extends EventfulFields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="eventful-sortable-item">';
          ...
          Eventful::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="eventful-sortable-helper"><i class="icofont-drag"></i></div>';
