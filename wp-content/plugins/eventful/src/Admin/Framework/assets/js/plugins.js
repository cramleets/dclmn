...
(function($) {
  ...
  function EVENTFULAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  EVENTFULAjaxChosen.prototype.init = function() {
  ...
  EVENTFULAjaxChosen.prototype.events = function() {
  ...
  EVENTFULAjaxChosen.prototype.search_field_focused = function() {
  ...
  EVENTFULAjaxChosen.prototype.search_welcome_message = function() {
  ...
  EVENTFULAjaxChosen.prototype.update_list = function() {
  ...
  EVENTFULAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      this.element.EVENTFULChosenOrder($hidden_value, true);
  ...
  $.fn.EVENTFULAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new EVENTFULAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, EVENTFULAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  EVENTFULAbstractChosenOrder = (function() {

    function EVENTFULAbstractChosenOrder() {}

    EVENTFULAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    EVENTFULAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    EVENTFULAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    EVENTFULAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    EVENTFULAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    EVENTFULAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    EVENTFULAbstractChosenOrder.EVENTFULChosenOrder = function(select, order, force) {
    ...
    return EVENTFULAbstractChosenOrder;
  ...
  $.fn.extend({
    EVENTFULChosenOrder: function(order, force) {
      return _EVENTFULChosenOrder.EVENTFULChosenOrder(this, order, force);
    }
  });

  this._EVENTFULChosenOrder = (function(_super) {
    __extends(_EVENTFULChosenOrder, _super);

    function _EVENTFULChosenOrder() {
      _ref = _EVENTFULChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _EVENTFULChosenOrder.relAttributeName = 'data-option-array-index';

    _EVENTFULChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _EVENTFULChosenOrder.getDOMElement = function(element) {
    ...
    _EVENTFULChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _EVENTFULChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _EVENTFULChosenOrder;

  })(EVENTFULAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectEVENTFUL = FormSerializer.serializeObject;
    $.fn.serializeJSONEVENTFUL   = FormSerializer.serializeJSON;
  }
