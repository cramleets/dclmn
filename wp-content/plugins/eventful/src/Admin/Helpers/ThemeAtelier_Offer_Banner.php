 ...
 *
 * @package    Eventful
 * @subpackage Eventful/src/Admin/Helper
...
class ThemeAtelier_Offer_Banner {
	...
	public function get_active_offers() {
		...
		$offers = array(
			'growth_sale'     => array(
				...
				'image' => EVENTFUL_DIR_URL . 'src/Admin/assets/img/growth-sale.svg',
				'link'  => 'https://wpeventful.com/pricing/?utm_source=eventful_plugin&utm_medium=offer_banner&utm_campaign=may_2026',
			),
			...
			'mid_year_sale'     => array(
				...
				'image' => EVENTFUL_DIR_URL . 'src/Admin/assets/img/mid-year-mega-sale.svg',
				'link'  => 'https://wpeventful.com/pricing/?utm_source=eventful_plugin&utm_medium=offer_banner&utm_campaign=mid_year_2026',
			),

			'independence_day_sale'     => array(
				'id'    => 'independence_day_2026',
				'start' => strtotime( '2026-07-01 00:00:00' ),
				'end'   => strtotime( '2026-07-31 23:59:59' ),
				'image' => EVENTFUL_DIR_URL . 'src/Admin/assets/img/independence-day-sale.svg',
				'link'  => 'https://wpeventful.com/pricing/?utm_source=eventful_plugin&utm_medium=offer_banner&utm_campaign=independence_day_2026',
			),
	...
	public function render_offer_banner() {
		...
		foreach ( $active_offers as $offer ) {
			...
			$nonce = wp_create_nonce( 'eventful_offer_dismiss' );
			?>
	...
	public function dismiss_offer_banner() {
		check_ajax_referer( 'eventful_offer_dismiss', 'nonce' );
