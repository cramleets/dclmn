...
class Insights {
    ...
    public function admin_notice() {
        ...
        $notice .= '<p class="description hidden" style="display:none;">' . implode( ', ', $this->data_we_collect() ) . '. No sensitive data is tracked. ';
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . esc_html( $this->client->eventful_trans( 'Allow' ) ) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . esc_html( $this->client->eventful_trans( 'No thanks' ) ) . '</a>';
        echo '</p></div>';
    ...
    /**
     * Get the number of event counts
     *
...
<div class="wd-dr-modal" id="<?php echo esc_attr( $this->client->slug ); ?>-wd-dr-modal">
    <div class="wd-dr-modal-wrap">
        ...
        <div class="wd-dr-modal-body">
            <?php
            $allowed_svg = array(
                'svg'  => array( 'xmlns' => array(), 'width' => array(), 'height' => array(), 'viewbox' => array(), 'fill' => array(), 'stroke' => array(), 'stroke-width' => array(), 'class' => array() ),
                'g'    => array( 'fill' => array(), 'stroke' => array(), 'class' => array() ),
                'path' => array( 'd' => array(), 'fill' => array(), 'stroke' => array(), 'stroke-width' => array(), 'fill-rule' => array(), 'clip-rule' => array() ),
            ...
            <ul class="wd-de-reasons">
                ...
                <li data-placeholder="<?php echo esc_attr( $reason['placeholder'] ); ?>">
                    <label>
                        ...
                        <div class="wd-de-reason-icon"><?php echo wp_kses( $reason['icon'], $allowed_svg ); ?></div>
