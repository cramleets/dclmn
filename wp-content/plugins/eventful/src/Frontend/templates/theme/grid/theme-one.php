 ...
 * Theme One
 *
 * This template can be overridden by copying it to yourtheme/eventful/templates/theme/theme-one.php
 *
...
if ($event_thumb_right_meta === 'taxonomy') {
    ob_start();
    EventfulFunctions::eventful_thumb_meta($event, $event_thumb_right_meta, $event_thumb_right_meta_position, $event_thumb_meta_taxonomy_right);
    echo wp_kses_post(apply_filters('eventful_thumb_' . $event_thumb_right_meta . '', ob_get_clean()));
} elseif ($event_thumb_right_meta === 'date') {
    ob_start();
    EventfulFunctions::eventful_thumb_meta($event, $event_thumb_right_meta, $event_thumb_right_meta_position);
    echo wp_kses_post(apply_filters('eventful_thumb_' . $event_thumb_right_meta . '', ob_get_clean()));
} elseif ($event_thumb_right_meta === 'venue') {
    ob_start();
    EventfulFunctions::eventful_thumb_meta($event, $event_thumb_right_meta, $event_thumb_right_meta_position);
    echo wp_kses_post(apply_filters('eventful_thumb_' . $event_thumb_right_meta . '', ob_get_clean()));
} elseif ($event_thumb_right_meta === 'organizer') {
    ob_start();
    EventfulFunctions::eventful_thumb_meta($event, $event_thumb_right_meta, $event_thumb_right_meta_position);
    echo wp_kses_post(apply_filters('eventful_thumb_' . $event_thumb_right_meta . '', ob_get_clean()));
} elseif ($event_thumb_right_meta === 'social_media') {
    ob_start();
    EventfulFunctions::eventful_thumb_meta($event, $event_thumb_right_meta, $event_thumb_right_meta_position);
    echo wp_kses_post(apply_filters('eventful_thumb_' . $event_thumb_right_meta . '', ob_get_clean()));
}
...
echo '<div class="event__content">' . wp_kses_post($eventful_post_content) . '</div>';
