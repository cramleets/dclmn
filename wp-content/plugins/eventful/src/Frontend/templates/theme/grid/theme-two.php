 ...
 * Theme Two
 *
 * This template can be overridden by copying it to yourtheme/eventful/templates/theme/theme-two.php
 *
...
$event_thumb_meta_background = isset($options['event_thumb_meta_background']) ? $options['event_thumb_meta_background'] : array();
$background_color = !empty($event_thumb_meta_background['background-color']) ? $event_thumb_meta_background['background-color'] : 'rgba(0,0,0,.8)';
$background_gradient_color = !empty($event_thumb_meta_background['background-gradient-color']) ? $event_thumb_meta_background['background-gradient-color'] : 'rgba(0,0,0,.8)';
$background_gradient_direction = !empty($event_thumb_meta_background['background-gradient-direction']) ? $event_thumb_meta_background['background-gradient-direction'] : 'to right';
...
ob_start();
EventfulFunctions::eventful_thumb_meta(
    $event,
    'date',
    'thumb_bottom',
    '',
