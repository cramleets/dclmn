...
if (! class_exists('EventfulImageResizer')) {

	/**
	 * EventfulImageResizer
	 */
	class EventfulImageResizer
	{
		...
		/**
		 * For your custom default usage you may want to initialize an EventfulImageResizer object by yourself and then have own defaults
		 *
		 * @return statement
		 */
		 ...
		 * @throws Exception Validate inputs.
		 * @return statement
		 */
		public function process($url, $width = null, $height = null, $crop = null, $single = true, $upscale = false)
		{
			try {
				...
				if (true === $upscale) {
					add_filter('image_resize_dimensions', array($this, 'eventful_upscale'), 10, 6);
				}
				...
				*/
				...
				// Okay, leave the ship.
				if (true === $upscale) {
					remove_filter('image_resize_dimensions', array($this, 'eventful_upscale'));
				}
				// Return the output.
				if ($single) {
					// str return.
				...
				error_log('EventfulImageResizer.process() error: ' . $ex->getMessage());
		 ...
		 * @return statement
		 */
		public function eventful_upscale($default, $orig_w, $orig_h, $dest_w, $dest_h, $crop)
		{
			if (! $crop) {
