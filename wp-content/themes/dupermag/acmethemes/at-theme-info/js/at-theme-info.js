jQuery(document).ready(function ($) {
    ...
    var at_theme_info_count_actions_recommended = dupermag_theme_info_object.count_actions_recommended;
    ...
    jQuery(".at-theme-info-recommended-action-button,.reset-all").click(function() {
        ...
        jQuery.ajax({
            ...
            dataType  : "html",
            url       : dupermag_theme_info_object.ajaxurl,
            beforeSend: function (data, settings) {
                jQuery('.at-theme-info-tab-pane#actions_required h1').append('<div id="temp_load" style="text-align:center"><img src="' + dupermag_theme_info_object.template_directory + '/acmethemes/at-theme-info/images/ajax-loader.gif" /></div>');
            },
    ...
    jQuery(".acme-set-image").click(function() {
        ...
        jQuery.ajax({
            ...
            url       : dupermag_theme_info_object.ajaxurl,
            beforeSend: function (data, settings) {
                jQuery('.acme-set-image').append('<div id="temp_load" style="text-align:center"><img src="' + dupermag_theme_info_object.template_directory + '/acmethemes/at-theme-info/images/ajax-loader.gif" /></div>');
            },
            success   : function (data) {
                jQuery("#temp_load").remove();
