	...
	public function getting_started() {
        ...
        <div id="at-gsm" class="updated notice-info at-gsm">
            ...
            <div class="at-gsm-container">
                <img class="at-gsm-screenshot" src="<?php echo esc_url(get_template_directory_uri().'/screenshot.jpg' )?>" alt="<?php esc_attr_e( 'SuperMag', 'supermag' ); ?>" />
                <div class="at-gsm-notice">
                    ...
                    <p class="plugin-install-notice"><?php esc_html_e( 'Clicking the button below will install and activate the Acme Demo Setup and Advanced Import plugins.', 'supermag' ); ?></p>

                    <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="<?php esc_attr_e( 'Get started with SuperMag', 'supermag' ); ?>">
